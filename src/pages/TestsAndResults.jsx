                  ...
                  >
                    ...
                    <div>
                      ...
                      <div className="flex items-center gap-2 mt-2">
                        ...
                        {/* Status Badge */}
                        {test.status === 'Ongoing' ? (
                          <span className="flex items-center gap-1 px-2 py-0.5 rounded-full text-[10px] font-bold uppercase tracking-wider bg-emerald-100 text-emerald-700 border border-emerald-200">
                      ...
                      {!isAdmin && (
                        <button
                          ...
                          className={`flex items-center gap-2 px-3 py-1.5 rounded-md text-sm font-medium transition-all ${
                            test.status === 'Ongoing' 
                              ? "bg-[var(--color-primary)] text-white hover:shadow-lg shadow-[var(--color-primary)]/20" 
                              : "bg-[var(--color-bg)] text-[var(--color-text-muted)] border border-[var(--color-border)] cursor-not-allowed grayscale opacity-60"
                          }`}
                        >
                          <PlayCircle className="w-4 h-4" />
                          {test.status === 'Ongoing' ? 'Start' : test.status === 'Upcoming' ? 'Wait' : 'Ended'}
                        </button>
                      )}
